...
button{
    ...
    <div style="position: absolute;right:65%;top:5%;">
            <h2 style="position: absolute;right:26%;top:-1%;">Top 5 Liked Posts</h2>
        <!-- <button><a style="text-decoration:none;" href="top5posts.php">VIEW TOP 5 LIKED POSTS</a></button>-->
    <?php
...
?>
    ...
    <div style = "float:right; position: relative;margin-top: 9%;left:-11%;">
